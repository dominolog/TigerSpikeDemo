...
public class Constants {
	...
	public static final String API_KEY = "eb040ddc4d9d5aafa006c7cbcd45915d";
	public static final String API_SECRET = "caac23cf5098975c";

	public static final String WEB_SERVICE_URL = "https://api.flickr.com/";
